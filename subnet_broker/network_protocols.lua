--[[
  AutoOS — Network protocols (broker deploy copy)

  Keep in sync with shared/network_protocols.lua. Copied here so the worker
  PC only needs files under /home/subnet_broker/.
]]
