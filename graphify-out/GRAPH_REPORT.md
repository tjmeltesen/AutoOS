...
## Corpus Check
- 126 files · ~83,975 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 759 nodes · 958 edges · 21 communities detected
...
- **Why does `print()` connect `Community 1` to `Community 3`, `Community 5`, `Community 6`?**
  _High betweenness centrality (0.119) - this node is a cross-community bridge._
- **Why does `BrokerMain.run()` connect `Community 5` to `Community 1`, `Community 9`?**
