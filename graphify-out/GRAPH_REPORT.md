...
## Corpus Check
- 126 files · ~83,304 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 751 nodes · 944 edges · 21 communities detected
...
Cohesion: 0.04
Nodes (17): CentralDispatch:_item_adapter(), CentralDispatch:_lane_fluid_tp(), CentralDispatch:_lane_item_tp(), CentralDispatch:tick(), fingerprint_equal(), CircuitManager:scan_transposer(), CircuitManager:_transfer_with_retries(), find_machine() (+9 more)
...
Cohesion: 0.08
Nodes (32): try(), event.pull(), clear_all(), join(), list_lua(), main(), print(), read_head() (+24 more)
...
- **Why does `print()` connect `Community 3` to `Community 2`, `Community 6`, `Community 15`?**
  _High betweenness centrality (0.119) - this node is a cross-community bridge._
- **Why does `BrokerMain.run()` connect `Community 6` to `Community 9`, `Community 3`?**
  _High betweenness centrality (0.098) - this node is a cross-community bridge._
- **Why does `Kernel.new()` connect `Community 8` to `Community 13`, `Community 15`?**
