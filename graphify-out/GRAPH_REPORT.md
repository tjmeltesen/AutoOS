# Graph Report - AutoOS  (2026-06-21)

## Corpus Check
- 150 files · ~121,480 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1079 nodes · 1457 edges · 31 communities detected
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 230 edges (avg confidence: 0.8)
...
Cohesion: 0.07
Nodes (30): ArrayWatch.new(), boot(), BrokerMain.build(), BrokerMain._build_impl(), BrokerMain.run(), BrokerMain.run_once(), print_lane_status(), BrokerUI.new() (+22 more)
...
Cohesion: 0.07
Nodes (19): Adapter.new(), Arbitrator:commit(), Arbitrator:_craft_slot_available(), Arbitrator.new(), machine_idle(), select_intent(), Kernel.new(), filter_match() (+11 more)
...
- **Why does `print()` connect `Community 1` to `Community 2`, `Community 5`, `Community 6`, `Community 39`, `Community 11`, `Community 18`, `Community 23`?**
  _High betweenness centrality (0.165) - this node is a cross-community bridge._
- **Why does `BrokerMain.run()` connect `Community 6` to `Community 1`, `Community 18`, `Community 14`?**
  _High betweenness centrality (0.114) - this node is a cross-community bridge._
- **Why does `BrokerMain.build()` connect `Community 6` to `Community 10`, `Community 3`?**
