...
## Corpus Check
- 129 files · ~88,104 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 809 nodes · 1018 edges · 22 communities detected
...
Cohesion: 0.06
Nodes (28): CentralDispatch:_bus_empty(), CentralDispatch:_machine_available(), CentralDispatch:_return_empty(), _debug_escape(), _debug_json(), _debug_write(), lane_default(), LaneDispatch:_buffer_has_fluid() (+20 more)
...
- **Why does `BrokerMain.run()` connect `Community 5` to `Community 0`, `Community 11`, `Community 14`?**
  _High betweenness centrality (0.100) - this node is a cross-community bridge._
- **Why does `Kernel.new()` connect `Community 6` to `Community 0`, `Community 15`?**
