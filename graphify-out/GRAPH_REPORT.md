...
## Corpus Check
- 124 files · ~77,286 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 693 nodes · 840 edges · 20 communities detected
...
1. `print()` - 21 edges
2. `BrokerMain.run()` - 14 edges
3. `clean()` - 13 edges
4. `pcallR()` - 11 edges
5. `run_probe_embedded()` - 9 edges
6. `HW.require_proxy()` - 8 edges
7. `cmd_listen()` - 8 edges
8. `cmd_ping()` - 8 edges
9. `OrchestratorMain.build()` - 8 edges
10. `main()` - 8 edges
...
Cohesion: 0.05
Nodes (36): CircuitManager:scan_transposer(), CircuitManager:_transfer_with_retries(), find_machine(), run_probe_embedded(), HW.on_network(), HW.proxy(), HW.require_proxy(), HW.sleep() (+28 more)
...
Cohesion: 0.1
Nodes (20): try(), event.pull(), clear_all(), join(), list_lua(), main(), print(), read_head() (+12 more)

### Community 5 - "Community 5"
Cohesion: 0.07
Nodes (14): ArrayWatch.new(), BrokerMain.run(), print_lane_status(), component.isAvailable(), Config.validate(), normalize_machine(), LaneDispatch.new(), me_proxy() (+6 more)
...
## Knowledge Gaps
- **Thin community `Community 18`** (11 nodes): `component.doc()`, `component.get()`, `component.getPrimary()`, `component.invoke()`, `component.list()`, `component.methods()`, `component.proxy()`, `component.setPrimary()`, `component.slot()`, `component.type()`, `component.lua`
...
- **Why does `print()` connect `Community 4` to `Community 0`, `Community 2`, `Community 5`, `Community 14`?**
  _High betweenness centrality (0.111) - this node is a cross-community bridge._
- **Why does `BrokerMain.run()` connect `Community 5` to `Community 16`, `Community 9`, `Community 4`, `Community 8`?**
  _High betweenness centrality (0.100) - this node is a cross-community bridge._
- **Why does `Kernel.new()` connect `Community 7` to `Community 12`, `Community 14`?**
  _High betweenness centrality (0.057) - this node is a cross-community bridge._
- **Are the 17 inferred relationships involving `print()` (e.g. with `try()` and `log_sensor_lines()`) actually correct?**
  _`print()` has 17 INFERRED edges - model-reasoned connections that need verification._
